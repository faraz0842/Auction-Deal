    ...
    <tbody class="fw-semibold text-gray-600">
        @foreach ($listings as $listing)
            <tr>
                ...
                <td class="text-center">
                    @role('superadmin')
                        <a href="{{ Route('listing.details', $listing->slug) }}" data-toggle="tooltip" data-placement="top"
                           title="View Product" class="btn btn-sm btn-success fs-8 fw-bold"><i class="fa fa-eye"></i></a>
                    <span data-toggle="tooltip" data-placement="top"
                          title="Delete Listing">
                        <a href="{{ Route('admin.listing.destroy', $listing->slug) }}"  class="btn btn-sm btn-danger fs-8 fw-bold"><i
                                class="fa fa-trash"></i></a>
                    </span >

                    @else
                        <a href="{{ Route('listing.details', $product->slug) }}" data-toggle="tooltip" data-placement="top"
                            title="View Product" class="btn btn-sm btn-success fs-8 fw-bold"><i class="fa fa-eye"></i></a>
                        <a href="{{ Route('listing.edit', $listing->slug) }}" data-toggle="tooltip" data-placement="top"
                            title="Edit Product" class="btn btn-sm btn-info fs-8 fw-bold"><i class="fa fa-edit"></i></a>
                        <span data-toggle="tooltip" data-placement="top"
                              title="Delete Listing">
                        <a href="{{ Route('admin.listing.destroy', $listing->slug) }}"  class="btn btn-sm btn-danger fs-8 fw-bold"><i
                                class="fa fa-trash"></i></a>
