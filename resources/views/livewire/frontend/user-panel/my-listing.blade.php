            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
                ...
                @foreach ($listings as $listing)
                    <tr>
                        ...
                        <td class="text-center">
                            <span
                                class="fw-bold badge {{ StatusCssClassHelper::listingStatusCssClass($listing->status,'badge') }}">
                                {{ Str::upper($listing->status) }}
                            </span>
                        </td>
                        <td class="text-center">
                            <a href="{{route('listing.details',$listing->slug)}}"
                               data-bs-toggle="tooltip" data-bs-placement="top" title="View Listing"
                               class="btn btn-icon btn-primary btn-sm mr-2"><i
                                    class="bi bi-eye fs-4"></i></a>
                            <a href="#"
                               data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Listing"
                               class="btn btn-icon btn-success btn-sm mr-2"><i
                                    class="bi bi-pencil fs-4"></i></a>
                            <span data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Listing">
                                <a class="btn btn-icon btn-danger btn-sm mr-2" data-bs-toggle="modal"
                                   data-bs-target="#delete{{ $listing->slug }}"><i
