<div class="card card-flush">
    <div class="card-body">
        ...
        <div class="flex-row-fluid">
            ...
            <form class="form" wire:submit.prevent="updateListing">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-6">
                        <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                            <span class="required">Parent Category</span> &nbsp;<a href="javascript:void(0)"
                                wire:click="visibilityParentCategoryForm(true)">Add
                                New</a>
                        </label>
                    ...
                    <div class="col-md-3 mb-6">
                        <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                            <span class="required">Child Category</span> &nbsp;<a href="javascript:void(0)"
                                wire:click="visibilityChildCategoryForm(true)">Add
                                New</a>
                        </label>
                    ...
                    <div class="mb-6 {{ $showParentCategoryForm ? '' : 'd-none' }}">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <button wire:click="storeNewParentCategory" class="btn btn-success  mt-14">Add
                                </button>
                            </div>
                    ...
                    <div
                        ...
                        <div class="col-md-12 mb-6">
                            ...
                            @if (
                                ...
                                <div class="col-md-12 mb-6 {{ is_null($productPrice) ? 'd-none' : '' }}">
                        ...
                        <div
                            ...
                            @error('discountedProductPrice')
                                <div class="error text-danger">{{ $message }}</div>
                            @enderror
                            <div class="col-md-12 mb-6 {{ is_null($discountedProductPrice) ? 'd-none' : '' }}">
                                <div class="d-flex flex-stack align-items-center">
                                    <div>
                                        <span class="fs-5 fw-bold">Selling Fee</span>
                                        <span class="ms-1" data-bs-toggle="tooltip"
                    ...
                    <div
                        ...
                        <div class="col-md-12 mb-6 {{ is_null($startingBid) ? 'd-none' : '' }}">
                            <div class="d-flex flex-stack align-items-center">
                                <div>
                                    <span class="fs-5 fw-bold">Selling Fee</span>
                                    <span class="ms-1" data-bs-toggle="tooltip"
                    ...
                    <div class="col-md-12">
                        <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                            <span class="required">Select Pick up Address</span> &nbsp;<a href="javascript:void(0)"
                                wire:click="visibilityPickUpAddressForm(true)">Add
                                New</a>
                        </label>
                    ...
                    <div class="col-md-12 mb-6 mt-5" wire:ignore>
                        ...
                        <select wire:ignore wire:model.lazy="selectedCommunities" name="selectedCommunities[]"
                            ...
                            @foreach ($fetchCommunities as $fetchCommunity)
                                <option value="{{ $fetchCommunity->id }}"
                                    {{ in_array($fetchCommunity->id, $selectedCommunities) ? 'selected' : '' }}>
                                    {{ $fetchCommunity->name }}
                                </option>
                            @endforeach
                        </select>
...
@push('scripts')
            ...
            init: function() {
                ...
                @foreach ($imgs as $file)
                    @if (str_contains($file->mime_type, 'image'))
                        ...
                        // Disable removal of existing files if desired
                ...
                this.on("addedfile", function(file) {
                    ...
                    if (myDropzone.files.length > maxFileCount) {
                        myDropzone.removeFile(file); // Remove the newly added file
                        Swal.fire({
                            title: 'Error!',
                            text: "You can't upload more than " + maxFileCount + " files!",
                            icon: 'warning',
                        });
                    }
                });
    ...
    <script type="text/javascript">
        var myDropzone = new Dropzone("#kt_dropzonejs_example_1", {
            ...
            init: function() {
                var myDropzone = this;
                var existingFiles = 0; // Variable to track the number of existing files
                ...
                @foreach ($imgs as $file)
                    @if (str_contains($file->mime_type, 'video'))
                        ...
                        existingFiles++; // Increment the count of existing files
                    @endif
                @endforeach

                // Set the maxFiles option based on the existing file count
                myDropzone.options.maxFiles -= existingFiles;

                // Disable addition of new files if the maximum limit is reached
                this.on("maxfilesexceeded", function(file) {
                    myDropzone.removeFile(file);
                    Swal.fire({
                        title: 'Error!',
    ...
    <script>
        function removeFile(file) {
            ...
            //deleteUrl = deleteUrl.replace(':file', file.url);
