                    ...
                    <div class="card card-flush py-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div wire:ignore>
                                    <input id="keywordTags" class="form-control" value="{{$keywordTags}}"
                            ...
                            <div class="col-md-12 d-flex justify-content-end mt-6">
                                ...
                                <button wire:click="updateKeyword" class="btn btn-primary">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('custom-scripts')
    <script>
        ...
        document.addEventListener("livewire:load", () => {
            ...
            let brandsData = @this.brands;
            let selectedBrand = @this.brand;

            keywordCategoryDropdown();

            keywordBrandDropdown();
            ...
            Livewire.on('brandsUpdated', function (brandsData) {
                ...
                keywordBrand.val(selectedBrand).trigger('change');
            });

            keywordCategory.val(selectedCategory).trigger('change');

        })

        function keywordCategoryDropdown() {
        ...
        function keywordTagifyInput() {
            let keywordTagInput = document.querySelector("#keywordTags");
            let tags = @this.keywordTags;

            let keywordTagify = new Tagify(keywordTagInput, {
                maxTags: 10,
                delimiters: ',',
                pattern: /^.{2,15}$/
            });

            keywordTagify.addTags(tags);
