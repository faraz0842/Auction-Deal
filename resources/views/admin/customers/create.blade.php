...
@section('title', 'Dealfair | Add Customer')
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Add Customer</h1>
                    {{ Breadcrumbs::render('adminAddCustomerPage') }}
                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input type="text" name="address"
                                                        ...
                                                        id="autocomplete" placeholder="Enter address here"
                                                        value="{{ old('address') }}" />
                                                    @error('address')
                                                ...
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input type="text" name="state"
                                                        class="form-control form-control-lg"
                                                        placeholder="Enter state here" value="{{ old('state') }}"
                                                        id="state" />
                                                    @error('state')
                                                        <div class="error text-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input type="text" name="zip"
                                                        class="form-control form-control-lg " placeholder="Enter zip here"
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <select name="country_id" aria-label="Select a country..."
                                                        data-control="select2" id="country"
