        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="#" class="d-lg-none">
                @if (GlobalHelper::getSettingValue('admin_logo'))
                    <img alt="Logo" src="{{ GlobalHelper::getSettingValue('admin_logo') }}" class="h-30px" />
                @else
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                        ...
                        <img src="{{ Auth::user()->getFirstMediaUrl('user_image') ? Auth::user()->getFirstMediaUrl('user_image') : asset('assets/media/avatars/blank.png') }}"
                            alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo"
                                        src="{{ Auth::user()->getFirstMediaUrl('user_image') ? Auth::user()->getFirstMediaUrl('user_image') : asset('assets/media/avatars/blank.png') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ Route('admin.account-settings.index') }}" class="menu-link px-5">Account
                                Settings</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
