                                ...
                                <form class="row g-5 pt-5" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        <div class="form-group row mb-6">
                                            ...
                                            <div class="col-md-6">
                                                <label class="col-form-label required fw-semibold fs-6">Template Key</label>
                                                <input type="text" name="key"
                                                       class="form-control form-control-lg mb-3 mb-lg-0"
                                                       placeholder="Enter template key here..."
                                                       value="{{ old('key') }}"/>
                                                @if ($errors->has('key'))
                                                    <div class="text-danger">
                                                        {{ $errors->first('key') }}
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea class="form-control tinymce_editor" name="content" rows="10">{{old('content')}}</textarea>
