                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-mute">Reported Stores</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                            ...
                            <table class="table align-middle border rounded table-row-dashed fs-6 g-5"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-center text-gray-400 fw-bold fs-7 text-uppercase">
                                        ...
                                        <th class="text-center min-w-100px">Store Name</th>
                                        <th class="text-center min-w-100px">Complain</th>
