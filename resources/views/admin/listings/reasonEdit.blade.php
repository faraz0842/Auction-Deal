                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted text-hover-primary">Edit Reported Reason</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                        ...
                        <div class="card-body">
                            <div class="card card-flush py-4">
                                <form class="row g-5 pt-5" method="POST" enctype="multipart/form-data"
                                    action="{{ route('admin.reported.reason.update', $reason->id) }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" name="type" class="form-control"
                                                value="{{ old('type', $reason->type) }}" placeholder="Reason Type">
                                            @if ($errors->has('name'))
