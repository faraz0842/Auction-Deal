...
@section('title', 'Dealfair | Add Category')
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Add Category</h1>
                    {{ Breadcrumbs::render('adminAddCategoryPage') }}
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                <form class="form d-flex flex-column flex-lg-row" action="{{ route('admin.category.store') }}"
                            ...
                            <div class="card-body pt-0">
                                @if($parentCategory)
                                    <div class="mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-lg mb-3 mb-lg-0"
                                               value="{{ $parentCategory->name }}" disabled/>
                                    </div>
                                ...
                                <div class="mb-5 fv-row">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-lg mb-3 mb-lg-0"
                                           placeholder="Enter category name here..." value="{{ old('name') }}"/>
                                    @error('name')
