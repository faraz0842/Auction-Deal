            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Article</h1>
                    {{ Breadcrumbs::render('adminAddArticlePage') }}
                </div>
                        ...
                        <div class="card-body">
                            <div class="card card-flush py-4">
                                <form class="row g-5 pt-5" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-6">
                                            ...
                                            <select name="category_id" aria-label="Select " data-control="select2"
                                                ...
                                                @foreach ($articleCateogories as $articleCategory)
                                                    <option value="{{ $articleCategory->id }}">{{ $articleCategory->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                        ...
                                        <div class="form-group mb-6">
                                            ...
                                            <select name="status" aria-label="Select " data-control="select2"
                                                ...
                                                <option
                                                    value="{{ \App\Enums\ArticleStatusEnum::PUBLISH->value }}">
                                                    {{ ucwords(\App\Enums\ArticleStatusEnum::PUBLISH->value) }}
                                                </option>
                                                <option value="{{ \App\Enums\ArticleStatusEnum::DRAFT->value }}">
                                                    {{ ucwords(\App\Enums\ArticleStatusEnum::DRAFT->value) }}</option>
                                            </select>
                                            @error('status')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="row mt-5 px-5 justify-content-end">
                                        <a href="{{ route('admin.article.index') }}"
                                           class="btn btn-light col-1 me-5">Cancel</a>
