                                        ...
                                        <span class="symbol symbol-50px me-2">
                                            <span class="symbol-label bg-light-info">
                                                ...
                                                <div class="d-flex flex-column text-end">
                                                    ...
                                                    <span class="text-muted fw-semibold mt-1">Total Communities</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-xl-stretch mb-xl-8">
                                        ...
                                        <span class="symbol symbol-50px me-2">
                                            <span class="symbol-label bg-light-danger">
                                                ...
                                                <div class="d-flex flex-column text-end">
                                                    <span class="text-dark fw-bold fs-2">+256</span>
                                                    <span class="text-muted fw-semibold mt-1">Total Members</span>
                                                </div>
                                            </div>
                                            <div class="statistics-widget-4-chart card-rounded-bottom"
                                ...
                                <a href="" class="card bg-success hoverable card-xl-stretch mb-xl-8">
                                    ...
                                    <div class="card-body">
                                        <div class="page-title flex-column flex-wrap">
                                            <!--begin::Title-->
                                            <h1 class="text-white flex-column">
                                                123</h1>
                                        </div>
                                        <!--end::Svg Icon-->
                                        <div class="text-white fw-bold fs-2 mb-2 mt-5">New Orders!
                                        </div>
                                    </div>
                                    <!--end::Body-->
                                </a>
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <a href="" class="card bg-warning hoverable card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-white fw-bold fs-2 mb-2 mt-5">New Tickets!
                                        </div>
                                    </div>
                                    <!--end::Body-->
                                </a>
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">Earnings</span>
                                </h3>
                            ...
                            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                                ...
                                <div class="px-9 mb-5">
                                    ...
                                    <!--end::Statistics-->
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold">Earning over time
                                    </span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Info-->
