...
@section('title', 'Dealfair | Edit Advertisement Plan')
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a class="text-muted text-hover-primary">Edit Advertisement Plan</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="card card-p-0 card-flush">
                        <div class="card-body">
                            <div class="card card-flush py-4">
                                ...
                                @endif
                                <form class="row g-5 pt-5" method="POST" action="{{route('admin.advertisement-plans.update', $advertisementPlan->id)}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="views"
                                                   ...
                                                   value="{{ old('views', $advertisementPlan->views) }}"/>
                                            @if ($errors->has('views'))
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="price"
                                                   ...
                                                   value="{{ old('price', $advertisementPlan->price) }}"/>
                                            @if ($errors->has('price'))
                                                <div class="text-danger">
                                                    {{ $errors->first('price') }}
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select name="status" class="form-select form-control-lg mb-3 mb-lg-0">
                                                ...
                                                <option value="active" {{old('status', $advertisementPlan->status) === \App\Enums\AdvertisementPlanEnum::ACTIVE->value ? 'selected' : ''}}>Active</option>
                                                <option value="inactive" {{old('status', $advertisementPlan->status) === \App\Enums\AdvertisementPlanEnum::INACTIVE->value ? 'selected' : ''}}>Inactive</option>
                                            </select>
